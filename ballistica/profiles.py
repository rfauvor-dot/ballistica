...
_QUERY_FILLER_WORDS = {
    ...
    "switch", "for", "with",
    # "Rifle" is store-wide shorthand here even though some of what it
    # matches against are really pistols (Rick's own naming convention
    # disambiguates by caliber/barrel/manufacturer in the name field
    # itself, not by a separate firearm-type field) -- these are the
    # words a shooter naturally reaches for out loud to mean "this gun"
    # that likewise never appear in the stored name itself.
